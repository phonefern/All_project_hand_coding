...
# Read the CSV file
csv_file_path = (r'C:\read_thermal\sumdata_2024\data_summary\data_simulate\simulate 02 _P\Training_2024_prepare_simu.csv')
...
#Test P1_p
# means = [0.39411, 0.39411, 0.39411, 0.39411]
# sds = [0.1265, 0.1687, 0.2109, 0.2531]
...
#Test P3_p
means = [0.39411, 0.39411, 0.39411, 0.39411, 0.39411, 0.39411, 0.39411]
sds = [0.2109, 0.0844, 0.1687, 0.2531, 0.3374, 0.4218, 0.5062]
...
for mean, sd in zip(means, sds):
    ...
    modified_csv_path = f'C:\read_thermal\sumdata_2024\data_summary\data_simulate\simulate 02 _P V.2\\Data_simulate_02_P_{mean}_{sd}.csv'
