...
# training_files = ['Train_balance_abnormal_normal_70_contcat3.csv']
# testing_files = ['Test_balance_abnormal_normal_30_concat3.csv']

# training_files = ['training_all_concat5.csv']
# testing_files = ['test_all_concat5.csv']
# training_files = ['Training_2024_V2.csv']
# training_files = ['Training_2024_use.csv']
# testing_files = ['Testing_2024.csv']
# testing_files = ['Testing_2024_v2.csv']

# training_files = ['merge_Training_70.csv']
# testing_files = ['merge_Testing_30.csv']

# training_files = ['Training_2024_V2_mod3.csv']
# testing_files = ['Testing_2024_mod3.csv']

# training_files = ['Data_normal_all.csv']
# testing_files = ['Data_All_Test_simulate.csv']

training_files = ['Training_2024_prepare_simu.csv']
testing_files = ['Data_simulate_03_N_0.39411_0.2109.csv']
...
def loadData(files):
    ...
    for i in files:
        df = df = pd.read_csv(f'C:\\read_thermal\sumdata_2024\data_summary\data_simulate\simulate 03 _N\\{i}')
...
for i in range(rounds):
    file_name = f'./model_save/CNN-LSTM--Batch_size-{batch_size}--Learning_rate-{learning_rate}--Layer_size_LSTM--{layer_size}-Layer_size_cnn-{layer_cnn}-Epochs--{num_epochs}--Dropout--{dropout}--round--{rounds}--simulate03_N.C2-B8_{testing_files}'
    ...
    with open(os.path.join(file_name, 'training_details.txt'), 'w') as file:
        ...
        start_time_round: float = time.time()
        print(lines)
        loss_num = 0
        ...
        total_params = count_parameters(cnn_model) + count_parameters(lstm_model)
